...
function UploadGoods() {
  ...
  const [id, setId] = useState(shortUUID.generate())
              ...
              <Card style={{ width: "60%", marginLeft: "20%" }}>
                <form onSubmit={handleSubmit}>
                  <FormControl
                    ...
                    placeholder="輸入合作店家名稱，不包含門市名稱（如：7-ELEVEN）"
                  ...
                  {/* <FormControl
                    style={{ margin: "30px 30px 0 30px", width: "90%" }}
                    placeholder="輸入合作店家地址（如：242新北市新莊區中正路510號）"
                  ...
                  <FormControl
                    style={{ margin: "30px 30px 0 30px", width: "90%" }}
                    placeholder="輸入合作店家電話（如：02-2905-6534）"
