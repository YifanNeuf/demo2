...
function UploadDemand() {
  ...
  let itemName = donateList.map((item) => {
  ...
  const [merchantTradeNo, setMerchantTradeNo] = useState(createMerchantTradeNo());
  ...
  const handleCreateOrder = async (e) => {
    ...
    const orderData = {
      ...
      TotalAmount: totalAmount,
      ReturnURL: 'https://us-central1-donation-platform-54f2b.cloudfunctions.net/returnResult',
      ChoosePayment: 'ALL',
      ClientBackURL: 'http://localhost:3000/donateList',
      ItemName: itemName,
    };
    try {
      await fetch('https://us-central1-donation-platform-54f2b.cloudfunctions.net/app', {
        method: 'POST',
        headers: {
    ...
    <div>
        ...
        <Container>
          ...
          <div style={stepBtnStyle}>
            ...
            {donateList !== null ? (
                <button onClick={handleCreateOrder} style={nextStepStyle}>前往付款</button>
            ) : ( "" )}
            {/* {donateList !== null ? (
